        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    System.out.println("Amount: " +  employeeServiceInterface.employeesWithNegativeSalary());
                    System.out.println();
                    break;
                case 5:
                    System.out.println("Employees with incorrect middle name field");
                    System.out.println("Amount: " + employeeServiceInterface.employeesWithBadMiddleName());
                    System.out.println();
                    break;
                case 6:

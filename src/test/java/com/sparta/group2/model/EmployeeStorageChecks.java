...
public class EmployeeStorageChecks {
  ...
  @Test
  @Order(12)
  void testStorageServiceGetDuplicateId(){
    Assertions.assertEquals(56, employeeStorageServiceInterface.listOfDuplicateIDs());
  }

  @Test
  @Order(13)
  void testStorageServiceGetBadMiddleNames(){
    Assertions.assertEquals(16, employeeStorageServiceInterface.employeesWithBadMiddleName());
  }

  @Test
  @Order(14)
  void testStorageServiceGetNegativeSalaries(){
    Assertions.assertEquals(9, employeeStorageServiceInterface.employeesWithNegativeSalary());
  }
